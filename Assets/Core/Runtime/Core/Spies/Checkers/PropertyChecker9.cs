...
{
    internal class PropertyChecker<TModel, T1, T2, T3, T4, T5, T6, T7, T8, T9> : IChecker<TModel>
    {
        ...
        private (T1, T2, T3, T4, T5, T6, T7, T8, T9) lastResult;
        ...
        {
            (T1, T2, T3, T4, T5, T6, T7, T8, T9) newResult = (f1(model), f2(model), f3(model), f4(model), f5(model), f6(model), f7(model), f8(model), f9(model));
            if (initialized)
            {
