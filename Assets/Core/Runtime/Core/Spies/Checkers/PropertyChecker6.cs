...
{
    internal class PropertyChecker<TModel, T1, T2, T3, T4, T5, T6> : IChecker<TModel>
    {
        ...
        private (T1, T2, T3, T4, T5, T6) lastResult;
        ...
        {
            (T1, T2, T3, T4, T5, T6) newResult = (f1(model), f2(model), f3(model), f4(model), f5(model), f6(model));
